...
Посмотреть сайт онлайн: https://shakhrukh0.github.io/front-end-entrance-exam/

## Вебстраница с резюме

Это персональная вебстраница с резюме, созданный с использованием HTML, CSS и JavaScript. В проекте реализованы редактируемые текстовые поля, интерактивные иконки-сердечки, ползунки уровня владения языками и возможность скачивания резюме в формате PDF. Изменения сохраняются локально и сайт адаптивен под мобильные устройства.

### Возможности
- Редактируемый контент с автоматическим сохранением
- Интерактивные элементы (переключение сердечек, выделение тегов)
- Ползунки с отображением уровня владения языками
...
1. Клонируйте репозиторий:
   ```bash
   git clone https://github.com/Shakhrukh0/front-end-entrance-exam.git
